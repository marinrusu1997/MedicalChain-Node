...
class MongoActionReader extends demux_1.AbstractActionReader {
    constructor(options = {}) {
        super(options);
        this.requiredCollections = new Set(['action_traces', 'block_states', 'account_controls', 'accounts', 'blocks', 'pub_keys', 'transaction_traces', 'transactions']);
    ...
    setup() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const collection of dbCollections) {
                if (!this.requiredCollections.has(collection.s.name)) {
                    missingCollections.push(collection.s.name);
                }
            }
